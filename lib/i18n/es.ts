...
const spanish: TranslationDictionary = {
  ...
  landing: {
    ...
    languagePicker: {
      ...
      loadError: "No se pudo cargar ese idioma. Comprueba tu conexión e inténtalo de nuevo.",
    },
    hero: {
      ...
      tour: {
        ariaLabel: "Recorrido de Exchange Notes en tres pasos",
        stepLabel: "Paso {current} de {total}",
        previous: "Paso anterior",
        next: "Paso siguiente",
        pause: "Pausar el recorrido",
        play: "Reproducir el recorrido",
        goToStep: "Ir al paso {step}: {title}",
        captureTitle: "Captura el momento",
        captureDescription: "Escríbelo, dilo o muéstralo. Yumi conserva el contexto junto al recuerdo.",
        languagesTitle: "Entiéndelo en cinco idiomas",
        languagesDescription: "Cambia toda la experiencia entre English, 繁體中文, Español, Français e Italiano.",
        rememberTitle: "Vuelve cuando importe",
        rememberDescription: "Tus notas, palabras compartidas y repasos siguen conectados, en lugar de perderse en un feed.",
      },
      write: "Escribir",
      voice: "Voz",
      camera: "Cámara",
  ...
  vocabulary: {
    ...
    detail: {
      ...
      edit: {
        ...
        wordPlaceholder: "Palabra o frase en {language}",
        translationPlaceholder: "Traducción en {language}",
        exampleLabel: "Ejemplo en {language}",
        examplePlaceholder: "Escribe un ejemplo en {language}.",
        close: "Cerrar la edición del vocabulario",
        cancel: "Cancelar",
        save: "Guardar los cambios",
        saving: "Guardando...",
        required: "El campo de {language} no puede estar vacío.",
