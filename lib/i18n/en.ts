...
const english: TranslationDictionary = {
  ...
  home: {
    ...
    hero: {
      ...
      descriptionCurious: "Murphy is curious about your new word.",
      titleCelebrate: "Great work",
      descriptionCelebrate: "Murphy is happy and full.",
      titleDancing: "Murphy is dancing",
    ...
    murph: {
      statusWaiting: "Murphy is waiting for a new word.",
      hintWaiting: "Learn one word to make Murphy smile.",
      statusCurious: "Murphy is curious.",
      hintOneWord: "1 new word today",
      statusHappy: "Murphy is getting excited.",
      hintWordsToday: "{count} new words today",
      statusDancing: "Murphy is dancing!",
      hintThreeWords: "You learned 3 new words today.",
      statusExcited: "Murphy is proud of you.",
      hintWordsCount: "{count} words today",
      statusHungry: "Murphy is a little hungry.",
      hintHungry: "Add one word to feed Murphy.",
      statusSad: "Murphy misses learning with you.",
      hintSad: "Murphy is waiting for you.",
      statusGrumpy: "Murphy is feeling grumpy.",
      hintGrumpy: "One new word can cheer Murphy up.",
      statusLonely: "Murphy is feeling lonely.",
      hintLonely: "Murphy misses you.",
      statusSleeping: "Murphy is resting.",
      hintSleeping: "Learn a new word to wake Murphy up.",
      statusWelcomeBack: "Murphy is happy to see you.",
      hintWelcomeBack: "Welcome back. Murphy missed you.",
      reactionCurious: "Murphy feels curious.",
      reactionHappy: "Murphy feels happy.",
    },
  ...
  vocabulary: {
    ...
    mascot: {
      greetingDefault: "Hello, Murph. What will you learn today?",
      greetingWaiting: "Murph is waiting for a new word.",
      moodStatus: {
        hungry: "Murph is hungry.",
        curious: "Murph is curious.",
        happy: "Murph is happy.",
        excited: "Murph is excited.",
        proud: "Murph is proud of you.",
        missingYou: "Murph missed you.",
        confused: "Murph looks puzzled.",
      },
      moodShort: {
        hungry: "Hungry",
        curious: "Curious",
      ...
      cookieTrayEmpty: "Add a word to earn Murph a cookie.",
      cookieTrayHint: "Drag a cookie onto Murph",
      cookieTrayMore: "+{count} more",
      feedAriaLabel: "Feed {word} to Murph",
