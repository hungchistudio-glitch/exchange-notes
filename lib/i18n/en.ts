import info from "@/lib/i18n/info/en";
...
const english: TranslationDictionary = {
  ...
  landing: {
    ...
    languagePicker: {
      ...
      loadError: "That language couldn't be loaded. Check your connection and try again.",
    },
    hero: {
      ...
      tour: {
        ariaLabel: "A three-step tour of Exchange Notes",
        stepLabel: "Step {current} of {total}",
        previous: "Previous step",
        next: "Next step",
        pause: "Pause tour",
        play: "Play tour",
        goToStep: "Go to step {step}: {title}",
        captureTitle: "Capture the moment",
        captureDescription: "Write it, say it, or show it. Yumi keeps the context with the memory.",
        languagesTitle: "Understand it in five languages",
        languagesDescription: "Switch the whole experience between English, Traditional Chinese, Spanish, French, and Italian.",
        rememberTitle: "Return when it matters",
        rememberDescription: "Your notes, shared words, and reviews stay connected instead of disappearing into a feed.",
      },
      write: "Write",
      voice: "Voice",
      camera: "Camera",
  ...
  vocabulary: {
    ...
    detail: {
      ...
      edit: {
        ...
        wordPlaceholder: "{language} word or phrase",
        translationPlaceholder: "{language} translation",
        exampleLabel: "{language} example",
        examplePlaceholder: "Write an example in {language}.",
