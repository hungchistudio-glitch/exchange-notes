  ...
  tutorial: {
    ...
    steps: {
      ...
      meet: {
        title: "嗨，我是 Yumi",
        body:
          "我住在你的首頁，跟你一樣，一次學一件新的事。給我一分鐘，我帶你看看每個地方是做什麼的。",
      },
      keys: {
        title: "六個永遠不會換位置的按鍵",
        body:
          "底部這一排的順序永遠一樣：單字、訊息、首頁、搜尋、探索、設定。只有那一圈亮起來的光環會移動，所以你的拇指很快就會記住每樣東西在哪裡。",
      },
      name: {
        title: "yu 和 mi",
        body:
          "Exchange Notes 其實是兩個人。yu 是你，mi 是我。你寫下一個你的語言裡的字，我寫下一個我的，然後我們交換。整個 app 就是這個交換。",
      },
      search: {
        title: "一個欄位，什麼字都能查",
        body:
          "看到不會的東西——招牌上、訊息裡、任何地方？打字、說出來，或用相機拍下來都可以。我會判斷它是哪一種語言、是什麼意思，以及你是不是已經學過。",
      },
      capture: {
        title: "對準任何東西",
        body:
          "把眼前的東西給我看，我會用兩種語言告訴你那是什麼，還附上一句你真的說得出口的例句。這是拿到第一個單字最快的方式。",
        action: "用這個方式加第一個單字",
      },
      vocabulary: {
        title: "你留下來的一切",
        body:
          "你存下的每個字都會來到這裡，連同那張照片、那個聲音，還有你第一次遇見它的那一刻——一個字會留下來，大半靠的就是那次相遇。快忘記的字會浮到最上面等你複習。",
      },
      discover: {
        title: "今天的故事",
        body:
          "真實的新聞，改寫成你讀得懂的程度。看到不會的字點一下，我就幫你存起來。",
        action: "從故事裡找第一個單字",
      },
      messages: {
        title: "交換發生的地方",
        body:
          "把一個字寄給你的夥伴，他們會收到完整的字卡跟發音。用 Exchange ID 加夥伴，或讓對方掃你的 QR Code——一個人學語言很辛苦，跟一個正好需要你母語的人一起學就不會。",
        action: "加我的第一個夥伴",
      },
      cosmic: {
        title: "一樣的學習，不一樣的氣氛",
        body:
          "Yumi 宇宙模式把首頁變成指揮艙，複習和導覽也換上更有動態的樣子。它不是另一個帳號：你的單字、訊息、夥伴和進度完全不變。隨時都能在設定裡切換。",
      },
      done: {
        title: "就這些了",
        body:
