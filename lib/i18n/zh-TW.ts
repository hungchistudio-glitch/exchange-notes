...
const traditionalChinese: TranslationDictionary = {
  ...
  landing: {
    navigation: {
      ariaLabel: "產品介紹導覽",
      homeAriaLabel: "Exchange Notes 產品介紹",
      start: "開始",
      opening: "開啟中…",
    },
    languagePicker: {
      label: "介面語言",
      ariaLabel: "選擇閱讀產品介紹的語言",
      loadError: "無法載入此語言。請檢查網路連線後再試一次。",
    },
    hero: {
      eyebrow: "一本看得見、也聽得懂的日記",
      title: "在它消失之前，把這一刻留下來。",
      intro:
        "寫下你正在想的、說出那些還不知道怎麼寫的，或直接讓 Yumi 看見你眼前的東西。",
      description:
        "你的日記會和你一起記得——把想法、情緒、影像與片刻連在一起，並在它們再次重要的時候，重新回到你身邊。",
      mantra: "寫下來 · 說出來 · 拍給它看",
      modeAriaLabel: "選擇記錄這一刻的方式",
      tour: {
        ariaLabel: "Exchange Notes 三步驟導覽",
        stepLabel: "第 {current} 步，共 {total} 步",
        previous: "上一步",
        next: "下一步",
        pause: "暫停導覽",
        play: "播放導覽",
        goToStep: "前往第 {step} 步：{title}",
        captureTitle: "先把這一刻留下來",
        captureDescription: "用文字、聲音或相機記錄，Yumi 會連同當下的脈絡一起保存。",
        languagesTitle: "用五種語言理解它",
        languagesDescription: "整個體驗可切換 English、繁體中文、Español、Français 與 Italiano。",
        rememberTitle: "在重要的時候再遇見",
        rememberDescription: "筆記、交換的單字與複習彼此連結，而不是消失在動態牆裡。",
      },
      write: "文字",
      voice: "語音",
      camera: "相機",
      cta: "開始記錄 — 使用 Google 繼續",
      ctaLoading: "正在開啟 Google…",
      preview: {
        ariaLabel: "日記記錄方式預覽",
        writeEyebrow: "文字記錄",
        writeSample: "回家路上的光，到現在還一直留在我心裡……",
        writeStatus: "已儲存為想法",
        voiceEyebrow: "語音辨識",
        voiceSample: "我還不知道該怎麼把它寫下來，但今天感覺有一點不一樣。",
        voiceStatus: "語音已辨識 · 逐字稿已完成",
        cameraEyebrow: "相機辨識",
        cameraSubject: "夕陽裡的銀杏葉",
        cameraDescription: "Yumi 已把這張影像和此刻連在一起。",
        cameraStatus: "畫面已辨識",
        memoryLinks: "這一刻連結了",
        thought: "想法",
        feeling: "情緒",
    ...
    notes: {
      ...
      description:
        "用雙語筆記替新單字留下脈絡，不需要按讚、回覆，也不需要觀眾。",
      previewAriaLabel: "雙語筆記預覽",
      date: "8 月 24 日",
    ...
    exchange: {
      eyebrow: "交換",
      title: "一個好用的詞，可以繼續往前走。",
      description:
        "把單字卡交給學習夥伴，讀音與意思會一起抵達；更像遞出一張紙條，而不是發佈到動態牆。",
      previewAriaLabel: "單字分享流程預覽",
      sender: "你的單字庫",
      senderCaption: "你收藏的詞",
      word: "留白",
      reading: "liú bái",
      meaning: "讓人呼吸的空間 · 有意留下的空白",
      receiver: "一位學習朋友",
      receiverCaption: "你的學習夥伴",
    },
    yumi: {
      eyebrow: "Yumi",
      title: "有人陪在旁邊，學習就輕一點。",
      description:
        "Yumi 會留意你收藏的單字、回應你的練習，也陪你回到正適合複習的內容。她陪你前進，而不是替你回答一切。",
      previewAriaLabel: "Yumi 學習夥伴預覽",
      message: "你今天留下了三個新單字，要不要帶一個回來快速複習？",
      translation:
    ...
    lens: {
      ...
      title: "你指哪裡，它就讀哪裡。",
      subtitle:
        "一份點不下去的菜單，或是雜亂畫面裡的某一樣東西 —— 相機兩種都處理，而且方式不同。",
      pickerAriaLabel: "選擇相機功能",
      previewAriaLabel: "相機功能預覽",
      cosmicBadge: "Yumi Cosmic Mode",
      menu: {
        label: "翻譯整份菜單",
        blurb: "每一道菜，順序與位置都留著。",
        detailOne: "菜單上原本的那一行、你語言裡的名字，還有怎麼唸。",
        detailTwo: "價格保持原樣，你可以直接指著實體菜單點餐。",
        detailThree: "每道菜都會說自己有多確定 —— 讀取與翻譯，分開講。",
        demoSource: "蒜泥白肉",
        ...
        demoConfidence: "讀取：高 · 翻譯：高",
      },
      target: {
        label: "只對焦一樣東西",
        blurb: "由你決定它讀什麼，而不是它猜。",
        detailOne: "相機把看得到的都提出來，你挑你真正要的那個。",
        detailTwo: "選中的框以四角標示，絕不只靠顏色分辨。",
        detailThree: "只讀那一個框，所以雜亂的架上也只給你一個乾淨的字。",
        demoSelected: "已選取",
        demoCandidate: "點一下選擇",
        demoResult: "茶壺",
      },
    ...
    closing: {
      title: "你不必今天學會所有事情。",
      titleSecond: "先留下一個值得再次遇見的詞。",
      description: "從一個詞開始，讓你的語言世界慢慢長在它身邊。",
      cta: "開始記錄 — 使用 Google 繼續",
      ctaLoading: "正在開啟 Google…",
    },
  },
  ...
  tutorial: {
    ...
    coach: {
      ...
      steps: {
        ...
        ask: {
          body:
            "查一個字給我看。打字、說話、拍下眼前任何東西，或是遞一張菜單、招牌、說明書給我 —— 四種都會回到同一張卡片上。",
        },
        keep: {
          body: "把它存起來。你存下的每一個字，都會變成我的一塊能量餅乾。",
        },
        feed: {
          body:
    ...
    steps: {
      ...
      setup: {
        title: "歡迎，先調整成你的樣子",
        body:
          "選擇我要用哪種語言和你說話，以及你正在學的語言。教學會立刻切換，接下來每一步都能用你最容易理解的方式介紹。",
      ...
      home: {
        title: "首頁與探索，組成每天的節奏",
        body:
          "首頁會顯示該複習的內容與記憶如何成長；探索則帶來適合你程度的真實故事。兩者一起給你一個值得回來的理由，不需要把所有內容一次做完。",
      },
      search: {
        title: "從你注意到的東西開始",
        body:
          "寫下來、說出來，或直接用相機給我看。我會判斷語言、解釋意思，也會告訴你是否曾經遇過。無論你在 app 的哪個地方，搜尋入口都在附近。",
      },
      notes: {
        title: "讓這個片刻有地方留下來",
        body:
          "每則筆記只保存一份原文，再加上它對你的意義、情境與標籤。你可以切換五種語言閱讀，只在需要時請我翻譯與解讀。筆記預設是私人內容，除非你主動分享。",
      },
      vocabulary: {
        title: "把有用的字變成記憶",
        body:
          "存下一個有用的字，它會帶著發音、意思與你遇見它的情境進入單字庫。我會在你的記憶需要時帶它回來，而不只是因為它剛加入。",
      },
      messages: {
        title: "交換，但不做成公開社群",
        body:
          "用 Exchange ID 或 QR Code 加入你信任的學習夥伴。你可以在訊息裡傳送字卡，也能用唯讀方式分享筆記。這裡沒有追蹤者或公開回應，只有你選擇的人。",
      },
      settings: {
        title: "控制權一直在你手上",
        body:
          "你可以在設定中更改語言、字體大小、提醒、裝置與個人資料。筆記預設私人、分享可以撤回；需要時，也能隨時重新開啟這份教學。",
      },
      cosmic: {
        title: "學習相同，只是換一種氛圍",
        body:
          "Yumi 星航模式會把首頁變成星際指揮艙，並用更專注、有動態感的方式呈現複習與導覽。它不是第二個帳號：你的筆記、單字、訊息、朋友與進度完全相同，隨時都能在設定裡切換。",
      },
      done: {
        title: "先從一件事開始",
        body:
          "你今天不必學會所有東西。留下一個值得再次找到的字、一句話或一個片刻就好。它再次重要時，我會陪你把它找回來。",
      },
    },
  },
  ...
  home: {
    ...
    notes: {
      ...
      viewAll: "查看全部",
      composerTitle: "新增筆記",
      composerDescription: "保留原本的想法；需要時再請 Yumi 用其他語言解讀。",
      originalLabel: "原文筆記",
      originalPlaceholder: "寫下一個詞、一句話或一個想法…",
      languageLabel: "原文語言",
      detectedHint: "已自動辨識，你也可以自行更改。",
      personalMeaning: "它對你的意義",
      personalMeaningPlaceholder: "選填：你自己的理解…",
      contextLabel: "使用情境",
      contextPlaceholder: "你在哪裡聽到，或什麼時候需要它？",
      tagsLabel: "標籤",
      tagsPlaceholder: "旅行、工作、感受",
      sourceLabel: "來源",
      sourcePlaceholder: "選填：來源或地點",
      privateLabel: "預設為私人",
      privateDescription: "在你分享給朋友之前，只有你看得到。",
      saveError: "無法儲存這則筆記，請檢查網路後再試一次。",
      libraryTitle: "筆記",
      libraryDescription: "同一個想法的所有語言版本都留在一起。",
      searchPlaceholder: "搜尋原文、翻譯、標籤與意思",
      allNotes: "全部",
      mine: "我的",
      sharedWithMe: "分享給我的",
      noResults: "找不到符合這次搜尋的筆記。",
      retry: "再試一次",
      loadError: "目前無法載入你的筆記。",
      detailEyebrow: "個人筆記",
      viewIn: "切換語言",
      yumiTitle: "問 Yumi",
      yumiDescription: "只在需要時取得自然翻譯、語意、語氣與在地脈絡。",
      interpret: "解讀這則筆記",
      interpreting: "Yumi 正在思考…",
      interpretError: "Yumi 目前無法解讀這則筆記，請連線後再試一次。",
      naturalTranslation: "自然翻譯",
      meaning: "意思",
      localExpressions: "在地說法",
      tone: "語氣",
      culturalNuance: "文化脈絡",
      usageExamples: "使用範例",
      warnings: "使用提醒",
      sharedBy: "由 {name} 分享",
      saveToMyNotes: "儲存到我的筆記",
      savedToMyNotes: "已儲存到我的筆記",
      saveCopyError: "無法儲存個人副本。",
      shareTitle: "分享筆記",
      shareDescription: "朋友只能檢視，你可以隨時撤銷權限。",
      noFriends: "請先新增朋友，再分享筆記。",
      viewOnly: "可檢視",
      shareError: "無法更新分享設定。",
      deleteConfirm: "要刪除這則筆記及其所有語言版本嗎？",
    },
  },
  ...
  vocabulary: {
    ...
    detail: {
      ...
      edit: {
        title: "編輯單字",
        subtitle: "更新單字與例句。",
        wordPlaceholder: "{language}單字或片語",
        translationPlaceholder: "{language}翻譯",
        exampleLabel: "{language}例句",
        examplePlaceholder: "輸入{language}例句。",
        close: "關閉編輯單字",
        cancel: "取消",
        save: "儲存變更",
        saving: "儲存中...",
        required: "{language}不可空白。",
        saveFailed: "儲存失敗。",
      },
