-- Repair Web Push schema.
--
-- Migration versions 20260804000001 and 20260804000002
-- were present in remote migration history, but the
-- web_push_subscriptions relation was absent.
-- Reapply the original idempotent schema and RPC SQL.
