...
import styles from "./ExchangeNotesLaunchV5.module.css";
...
export default function ExchangeNotesLaunchV5({
  reviewMode = false,
  onComplete,
}: Props) {
      ...
      <div className={styles.stage}>
        ...
        >
          ...
          <path
            ...
            d="M 122 286 Q 94 184 154 102"
            pathLength="100"
          />

          <circle className={styles.signalNode} cx="154" cy="102" r="5.8" />
